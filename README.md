...
- **原有学习工作台**：资料库、OCR、考点提取、复习计划、番茄钟、错题本、背诵卡片、白板、待办、统计、日记、文件加密等能力继续保留。
...
- **白板**：点、线、圆、弧、多边形、函数图、参数方程、极坐标、测量、撤销/重做和防抖自动保存。
...
内容采用本项目明确标注的离线整理方案，来源入口包括中国国家博物馆、中国政府网、国家图书馆、社会科学院近代史研究所、故宫博物院与相关国际档案/资料库。应用不把历史内容描述为完整覆盖，也不把有争议的数字或评价包装成唯一结论。
